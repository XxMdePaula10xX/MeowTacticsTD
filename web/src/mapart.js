...
(function (MT) {
  ...
  const DEFS = [
    { id: 'vulcao', name: 'Vulcão Ardente', theme: 'volcano', lanes: [
      [[-12, 4], [-6, 4], [-3, 1.5], [-4, -2], [-1, -4], [3, -3.5], [4, -0.5], [2, 2.5], [5, 4], [8, 3], [12, -1]] ] },
    ...
    { id: 'cristal', name: 'Caverna de Cristal', theme: 'crystal', lanes: [
      [[-12, 4], [-6, 4], [-2, 3], [3, 1], [7, 0]],
      [[-12, 0], [-4, 0], [0, 0], [3.5, 0], [7, 0]],
      [[-12, -4], [-6, -4], [-2, -3], [3, -1], [7, 0]] ] },
    { id: 'pantano', name: 'Pântano Sombrio', theme: 'swamp', lanes: [
      [[-12, 3], [-7, 1], [-3, 2], [0, 0], [3, 1], [7, -1], [12, 1]],
      [[-12, -3], [-7, -1], [-3, -2], [1, -0.5], [4, -2], [8, 0], [12, -3]] ] },
  ...
  // registra os mapas (paths suavizados)
  DEFS.forEach(d => {
    MT.DATA.maps.push({ id: d.id, name: d.name, lanes: d.lanes.length, theme: d.theme, bg: '', proc: true,
